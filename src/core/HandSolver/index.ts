...
export class HandSolver {
    /**
     * 计算手指与手腕的欧拉旋转角
     * @param {Array} lm : mediapipe传过来的手部坐标Landmark
     * @param {Side} side: 左手或者右手
     */
...
/**
 * 将标准化旋转值转换为由人为限制限制的弧度
 * @param {Object} hand : 标记关节对象的值
 * @param {Side} side : 左边或者右边
 */
