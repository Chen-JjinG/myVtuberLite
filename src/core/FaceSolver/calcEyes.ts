...
/**
 * 计算睁眼率并重新映射到0-1
 * @param {Array} lm : mediapipe的结果数组
 * @param {Side} side : 指定左侧或右侧
 * @param {Number} high : 眼睛被认定为是睁开的概率
 * @param {Number} low : 眼睛被认为是闭着的概率
 */
...
export const eyeLidRatio = (
    ...
    eyeInnerCorner: XYZ | Vector | number[], eyeOuterUpperLid: XYZ | Vector | number[],
